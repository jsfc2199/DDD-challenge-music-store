...
public class AddStringAccesory extends Command {
    ...
    public AddStringAccesory(AccesoryId accesoryId, StringAccesoryId stringAccesoryId, Value valueStringAccesory) {
